    ...
    <div className='bg-[var(--background)] text-[var(--foreground)] min-h-screen p-4 sm:p-6 md:p-8'>
      <div className='max-w-4xl mx-auto'>
        <section className='mb-12'>
          <h2 className='text-2xl sm:text-3xl font-semibold border-b-2 border-[var(--border)] pb-2 mb-4'>🦅 Gwaihir</h2>
          <p className='text-base sm:text-lg'>
            ...
            <br />
            <br />
            Yr brukes så lenge de har time-for-time data tilgjengelig. Den settes da sammen med atmosfærisk værdata fra
            ECMWF.
            <br />
        ...
        <section className='mb-12'>
          ...
          <p className='text-base sm:text-lg'>
            Gwaihir gjør det enklere å finne nye steder å fly, spesielt hvis du er i et område du ikke kjenner så godt
            til.
          </p>
          <br />
          ...
          <br />
          <p className='text-base sm:text-lg'>
            Alle starter er en egen side i menyen, her kan du ikke skjule starter uten lovende vær, men alt annet er
            tilgjengelig. Inkludert starter og vindmålinger utenfor Norge.
          </p>
        </section>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='p-4 rounded-lg shadow-[var(--shadow-md)] bg-[var(--background)] border border-[var(--border)]'>
              ...
              <ul className='list-disc list-inside space-y-2'>
                <li>
                  <strong>YR.no (Meteorologisk institutt):</strong> Primær værdata for validering og sammenligning.
                </li>
                <li>
                  <strong>Open-Meteo API:</strong> Sekundær værdata-kilde for detaljerte atmosfæriske forhold.
                </li>
                <li>
                  <strong>Windy.com:</strong> Interaktiv kart som burde brukes for å se høydevind i større områder.
                </li>
              </ul>
            </div>
            <div className='p-4 rounded-lg shadow-[var(--shadow-md)] bg-[var(--background)] border border-[var(--border)]'>
              ...
              <ul className='list-disc list-inside space-y-2'>
                <li>
                  <strong>FlightLog.org:</strong> Paragliding-starter og stedsinformasjon.{' '}
                </li>
                <li>
                  <strong>Holfuy.com:</strong> Værstasjoner.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className='mb-12'>
          ...
          <p className='text-base sm:text-lg'>
            ...
            , kontakt meg via e-post eller send inn en pull request. Alle bidrag er velkommen!
          </p>
        </section>
