  ...
  const dataRows = [
    {
      getValue: (hour: MinimalForecast) => {
        ...
        return weatherIcon ? (
          <Image src={weatherIcon.image} alt={weatherIcon.description} width={32} height={32} className='mx-auto' />
        ) : null;
      },
    },
    {
    ...
    {
      getValue: (hour: MinimalForecast) => (
        <WindDirectionArrow direction={hour.wind_direction} size={24} className='mx-auto' color='var(--foreground)' />
      ),
    },
  ];
