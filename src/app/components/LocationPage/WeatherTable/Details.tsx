    ...
    <div className='text-[var(--foreground)]'>
      ...
      <div className='mt-4'>
        ...
        <div className='grid grid-cols-5 gap-x-4 gap-y-2 text-sm'>
          ...
          <div className='font-medium'>{hour.geopotential_height_1000hpa}</div>
          ...
          <div className='font-medium'>{hour.geopotential_height_925hpa}</div>
          ...
          <div className='text-[var(--foreground)] font-medium'>
            {(
              (hour.temperature_925hpa - hour.temperature_1000hpa) /
              ((hour.geopotential_height_925hpa - hour.geopotential_height_1000hpa) / 100)
            ).toFixed(2)}
            °C
          </div>

          <div className='font-medium'>{hour.geopotential_height_850hpa}</div>
          ...
          <div className='text-[var(--foreground)] font-medium'>
            {(
              (hour.temperature_850hpa - hour.temperature_925hpa) /
              ((hour.geopotential_height_850hpa - hour.geopotential_height_925hpa) / 100)
            ).toFixed(2)}
            °C
          </div>
          <div className='font-medium'>{hour.geopotential_height_700hpa}</div>
          ...
          <div className='text-[var(--foreground)] font-medium'>
            {(
              (hour.temperature_700hpa - hour.temperature_850hpa) /
              ((hour.geopotential_height_700hpa - hour.geopotential_height_850hpa) / 100)
            ).toFixed(2)}
            °C
          </div>
        </div>
      ...
      <div className='mt-4'>
        <h4 className='font-bold text-lg mb-3 text-[var(--foreground)]'>Flere detaljer</h4>

        {/* Basic Weather Conditions */}
        <div className='mb-4'>
          <div className='space-y-1 text-sm'>
            {hour.pressure_msl != null && (
