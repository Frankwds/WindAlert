...
export default function LocationHeader({
  ...
  return (
    <div className='mb-4'>
      ...
      <h1 className='text-2xl font-bold ml-2 mb-4'>
        {name} ({altitude}m)
      </h1>
      ...
      <div className='relative'>
        ...
        {description.length > 800 && (
          ...
          >
            ...
            <button
              onClick={() => setIsExpanded(true)}
              className='cursor-pointer absolute bottom-0 right-16 h-8 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium px-2'
            >
              ...Vis alt &rarr;
            </button>
          </div>
