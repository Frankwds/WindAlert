...
const StationDataTable: React.FC<StationDataTableProps> = ({ stationData, timezone }) => {
              ...
              {data.wind_gust !== null ? (
                <div className='relative rounded w-11 flex items-center justify-center'>
                  <div
                    ...
                    style={{
                      backgroundColor: getWindSpeedColor(data.wind_gust > 1 ? data.wind_gust - 1 : data.wind_gust),
                    }}
                  />
      ...
      getValue: (data: StationData) => {
        ...
        return (
          <div className='relative rounded w-11 flex items-center justify-center'>
            ...
            />
            <span className='relative font-medium'>{`${temperature}°`}</span>
          </div>
        );
      },
    },
