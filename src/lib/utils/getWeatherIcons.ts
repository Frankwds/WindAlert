...
const weatherIconsMap: { [key: string]: WeatherIconData } = {
  ...
  "rainshowersandthunder_day": { description: "Regnbyger og torden", image: "/weather-icons/rainshowersandthunder_day.svg" },
  "rainshowersandthunder_night": { description: "Regnbyger og torden", image: "/weather-icons/rainshowersandthunder_night.svg" },
  ...
  "sleetshowersandthunder_day": { description: "Sluddbyger og torden", image: "/weather-icons/sleetshowersandthunder_day.svg" },
  "sleetshowersandthunder_night": { description: "Sluddbyger og torden", image: "/weather-icons/sleetshowersandthunder_night.svg" },
  "snowshowersandthunder_day": { description: "Snøbyger og torden", image: "/weather-icons/snowshowersandthunder_day.svg" },
  "snowshowersandthunder_night": { description: "Snøbyger og torden", image: "/weather-icons/snowshowersandthunder_night.svg" },
  ...
  "lightrainshowersandthunder_day": { description: "Lette regnbyger og torden", image: "/weather-icons/lightrainshowersandthunder_day.svg" },
  "lightrainshowersandthunder_night": { description: "Lette regnbyger og torden", image: "/weather-icons/lightrainshowersandthunder_night.svg" },
  "heavyrainshowersandthunder_day": { description: "Kraftige regnbyger og torden", image: "/weather-icons/heavyrainshowersandthunder_day.svg" },
  "heavyrainshowersandthunder_night": { description: "Kraftige regnbyger og torden", image: "/weather-icons/heavyrainshowersandthunder_night.svg" },
  "lightssleetshowersandthunder_day": { description: "Lette sluddbyger og torden", image: "/weather-icons/lightssleetshowersandthunder_day.svg" },
  "lightssleetshowersandthunder_night": { description: "Lette sluddbyger og torden", image: "/weather-icons/lightssleetshowersandthunder_night.svg" },
  "heavysleetshowersandthunder_day": { description: "Kraftige sluddbyger og torden", image: "/weather-icons/heavysleetshowersandthunder_day.svg" },
  "heavysleetshowersandthunder_night": { description: "Kraftige sluddbyger og torden", image: "/weather-icons/heavysleetshowersandthunder_night.svg" },
  "lightssnowshowersandthunder_day": { description: "Lette snøbyger og torden", image: "/weather-icons/lightssnowshowersandthunder_day.svg" },
  "lightssnowshowersandthunder_night": { description: "Lette snøbyger og torden", image: "/weather-icons/lightssnowshowersandthunder_night.svg" },
  "heavysnowshowersandthunder_day": { description: "Kraftige snøbyger og torden", image: "/weather-icons/heavysnowshowersandthunder_day.svg" },
  "heavysnowshowersandthunder_night": { description: "Kraftige snøbyger og torden", image: "/weather-icons/heavysnowshowersandthunder_night.svg" },
