...
const METEO_CODE_TO_YR_MAP: { [key: number]: (isDay: 0 | 1) => string } = {
  ...
  95: isDay => (isDay ? 'lightrainshowersandthunder_day' : 'lightrainshowersandthunder_night'), // Thunderstorm: Slight or moderate
  96: isDay => (isDay ? 'sleetshowersandthunder_day' : 'sleetshowersandthunder_night'), // Thunderstorm with slight hail
  99: isDay => (isDay ? 'heavysleetshowersandthunder_day' : 'heavysleetshowersandthunder_night'), // Thunderstorm with heavy hail
};
